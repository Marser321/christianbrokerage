        ...
        >
          <div className="overflow-hidden rounded-lg border border-white/15 bg-surface-card shadow-[0_28px_70px_rgba(0,0,0,0.26)]">
            {calendarSrc ? (
              <iframe
                src={calendarSrc}
                title={`Calendario ${vertical.eyebrow}`}
              ...
              <div className="flex min-h-[420px] flex-col items-center justify-center p-8 text-center text-heading">
                ...
                <h3 className="font-sans text-xl font-semibold text-heading">Coordinamos tu cita directamente</h3>
                <p className="mt-3 max-w-md text-sm leading-7 text-muted">
                  Escríbenos por WhatsApp o llama a la oficina para reservar el horario más conveniente. El calendario se activará cuando el equipo conecte la agenda pública.
                </p>
